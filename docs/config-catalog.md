...
Source: [`packages/terminal/terminal-bash-human/src/config.ts:6`](../packages/terminal/terminal-bash-human/src/config.ts)
...
Source: [`packages/terminal/terminal-pwsh/src/config.ts:6`](../packages/terminal/terminal-pwsh/src/config.ts)
