...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('terminal-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('terminal-not-found'), message: z.string(), details: z.object({ sessionId: z.string(), id: z.string() }) }),
  z.object({ code: z.literal('terminal-busy'), message: z.string(), details: z.object({ sessionId: z.string(), id: z.string() }) }),
