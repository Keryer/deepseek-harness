...
export type {
  ...
  JobView,
  TerminalApi, TerminalFrame, TerminalSessionView, TerminalSessionStatus, TerminalSessionId,
  TerminalSignal, TerminalWaitReason, TerminalSendResult, TerminalReadResult,
