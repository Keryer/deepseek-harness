...
export type {
  ...
  JobView,
  TerminalFrame, TerminalSessionId, TerminalSessionStatus, TerminalSessionView,
  TerminalApi, TerminalSignal, TerminalWaitReason, TerminalSendResult, TerminalReadResult,
  TerminalOpenRequest, TerminalSendRequest, TerminalReadRequest, TerminalResizeRequest,
  TerminalSignalRequest, TerminalCloseRequest, TerminalListRequest,
