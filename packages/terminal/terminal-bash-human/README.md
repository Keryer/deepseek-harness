...
- The shell is the user's login shell run interactively (`-i`): interactive rc files (`.bashrc`, `.zshrc`) are sourced for aliases, colors, and prompt, but a login profile (`.bash_profile`, `.zprofile`) is not read.
